...
export const categories: Category[] = [
  {
    ...
    imageUrl: '/src/assets/images/@a visit to alan lee\'s studio.jpg',
    slug: 'paintings',
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
  },
  {
    ...
    imageUrl: '/src/assets/images/download (35).jpg',
    slug: 'sculptures',
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
  },
  {
    ...
    imageUrl: '/src/assets/images/arts anf craft icon.jpg',
